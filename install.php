...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $step === 3) {
    ...
    try {
        ...
        $config_content .= " */\n\n";
        $config_content .= "// Définir les constantes pour la base de données\n";
        ...
        $config_content .= "// Variables pour compatibilité (certains fichiers les utilisent)\n";
        $config_content .= "\$db_host = DB_HOST;\n";
        $config_content .= "\$db_user = DB_USER;\n";
        $config_content .= "\$db_password = DB_PASS;\n";
